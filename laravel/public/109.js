  ...
  */
  ...
  methods: {
    ...
    update: function update() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(this.$apiAdress + '/api/roles/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token"), {
        _method: 'PUT',
        name: self.role.name
  ...
  mounted: function mounted() {
    var self = this;
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/roles/' + self.$route.params.id + '/edit?token=' + localStorage.getItem("api_token")).then(function (response) {
