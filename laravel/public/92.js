...
/* harmony import */ var cropperjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! cropperjs */ "../coreui/node_modules/cropperjs/dist/cropper.js");
...
/* harmony import */ var cropperjs_dist_cropper_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! cropperjs/dist/cropper.css */ "../coreui/node_modules/cropperjs/dist/cropper.css");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  folderIcon: _coreui_icons__WEBPACK_IMPORTED_MODULE_1__["cilFolder"],
  ...
  methods: {
    croppImage: function croppImage() {
      ...
      self.cropper.getCroppedCanvas().toBlob(function (blob) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(_this.$apiAdress + '/api/media/file/cropp', formData).then(function (response) {
    ...
    openCroppFileModal: function openCroppFileModal(id) {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/media/file?id=' + id + '&thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        ...
        self.$nextTick(function () {
          if (self.cropper !== null) {
            ...
            self.cropper = new cropperjs__WEBPACK_IMPORTED_MODULE_3___default.a(document.getElementById('cropp-img-img'), {
    ...
    deleteFolder: function deleteFolder() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/folder/delete?thisFolder=' + self.thisFolder + '&id=' + self.elementId + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
    ...
    deleteFile: function deleteFile() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/file/delete?thisFolder=' + self.thisFolder + '&id=' + self.elementId + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
        self.rightCard = 'fileInfo';
    ...
    renameOpenForm: function renameOpenForm(id, type) {
      ...
      if (type == 'folder') {
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/media/folder?id=' + id + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/media/file?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("api_token")).then(function (response) {
          self.name = response.data.name;
    ...
    moveFolder: function moveFolder() {
      if (this.selectFolder != null) {
        var self = this;
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/folder/move', {
          id: this.elementId,
    ...
    moveFile: function moveFile() {
      if (this.selectFolder != null) {
        var self = this;
        axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/file/move', {
          id: this.elementId,
          folder: this.selectFolder,
    ...
    copyFile: function copyFile(id) {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/media/file/copy?thisFolder=' + self.thisFolder + '&id=' + id + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
        self.rightCard = 'fileInfo';
      })["catch"](function (error) {
        console.log(error);
    ...
    renameFolder: function renameFolder() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/folder/update', {
        name: this.name,
        id: this.elementId,
        token: localStorage.getItem("api_token")
      }).then(function (response) {
    ...
    renameFile: function renameFile() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/file/update', {
        name: this.name,
        id: this.elementId,
        token: localStorage.getItem("api_token"),
        thisFolder: this.thisFolder
    ...
    handleFileUpload: function handleFileUpload(files, event) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post(this.$apiAdress + '/api/media/file/store?thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("api_token"), formData, {
        headers: {
    ...
    addFolder: function addFolder() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/media/folder/store?thisFolder=' + self.thisFolder + '&token=' + localStorage.getItem("api_token")).then(function (response) {
        self.getFoldersAndFiles(self.thisFolder);
      })["catch"](function (error) {
        console.log(error);
        self.$router.push({
    ...
    getFoldersAndFiles: function getFoldersAndFiles(folderId) {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/media?id=' + folderId + '&token=' + localStorage.getItem("api_token")).then(function (response) {
