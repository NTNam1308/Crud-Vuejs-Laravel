...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    update: function update() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(this.$apiAdress + '/api/menu/menu/update' + '?token=' + localStorage.getItem("api_token"), {
        name: self.name,
  ...
  mounted: function mounted() {
    var self = this;
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/menu/menu/edit?token=' + localStorage.getItem("api_token") + '&id=' + self.$route.params.id).then(function (response) {
