...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  */
  ...
  mounted: function mounted() {
    var self = this;
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/roles/' + self.$route.params.id + '?token=' + localStorage.getItem("api_token")).then(function (response) {
