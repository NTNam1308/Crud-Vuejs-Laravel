...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteUser: function deleteUser(id) {
      var self = this;
      var userId = id;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(this.$apiAdress + '/api/users/' + id + '?token=' + localStorage.getItem("api_token"), {
        _method: 'DELETE'
    ...
    getUsers: function getUsers() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/users?token=' + localStorage.getItem("api_token")).then(function (response) {
