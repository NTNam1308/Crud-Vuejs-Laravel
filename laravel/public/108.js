  ...
  */
  ...
  methods: {
    ...
    store: function store() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(this.$apiAdress + '/api/roles?token=' + localStorage.getItem("api_token"), {
        name: self.role.name
  ...
  mounted: function mounted() {
    var self = this;
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/roles/create?token=' + localStorage.getItem("api_token")).then(function (response) {
