...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    moveUp: function moveUp(id) {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/menu/element/move-up?token=' + localStorage.getItem("api_token") + '&id=' + id).then(function (response) {
        self.getElements();
    ...
    moveDown: function moveDown(id) {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/menu/element/move-down?token=' + localStorage.getItem("api_token") + '&id=' + id).then(function (response) {
        self.getElements();
      })["catch"](function (error) {
        console.log(error);
        self.$router.push({
    ...
    getElements: function getElements() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(this.$apiAdress + '/api/menu/element?token=' + localStorage.getItem("api_token") + '&menu=' + self.$route.params.menu).then(function (response) {
