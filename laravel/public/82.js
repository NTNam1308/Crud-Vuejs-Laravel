...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteEmail: function deleteEmail(id) {
      var self = this;
      var noteId = id;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post(this.$apiAdress + '/api/mail/' + id + '?token=' + localStorage.getItem("api_token"), {
        _method: 'DELETE'
    ...
    getTemplates: function getTemplates() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/mail?token=' + localStorage.getItem("api_token")).then(function (response) {
