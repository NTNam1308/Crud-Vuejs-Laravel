...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteMenu: function deleteMenu() {
      var self = this;
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(this.$apiAdress + '/api/menu/menu/delete?token=' + localStorage.getItem("api_token") + '&id=' + self.$route.params.id, {}).then(function (response) {
