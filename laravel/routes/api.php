...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::prefix('crud')->group(function () { 
        ...
        Route::get('/show',         'CrudController@show')->name('crud.show');
        Route::post('/store',   'CrudController@store')->name('crud.store');
        Route::get('/{id}/edit',     'CrudController@edit')->name('crud.edit');
        Route::post('/update',  'CrudController@update')->name('crud.update');
        Route::delete('/destroy',   'CrudController@destroy')->name('crud.destroy');
    });
    ...
    Route::group(['middleware' => 'admin'], function ($router) {
        ...
        //     Route::get('/{id}/edit',     'CrudController@edit')->name('crud.edit');
        //     Route::post('/update',  'CrudController@update')->name('crud.update');
        //     Route::get('/destroy',   'CrudController@destroy')->name('crud.destroy');
        // });
