...
const Cruds        = () => import('@/views/crud/Cruds')
const CreateCrud   = () => import('@/views/crud/CreateCrud')
const EditCrud     = () => import('@/views/crud/EditCrud')
const ShowCrud     = () => import('@/views/crud/ShowCrud')
      ...
      children: [
        {
          ...
          children: [
            ...
            {
              path: 'create',
              meta: { label: 'Create Crud Template' },
            ...
            {
              path: ':id',
              meta: { label: 'Show Crud Template'},
              props: true,
              name: 'Show Crud Tempalte',
              component: ShowCrud,
              
            },
            {
              path: ':id/edit',
              meta: { label: 'Edit Crud Tempalate' },
              name: 'Edit Crud Template',
              component: EditCrud,
